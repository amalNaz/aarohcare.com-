          ...
          <div className="max-w-xl xl:max-w-2xl">
            ...
            <div className="reveal-btn mt-8 sm:mt-10 lg:mt-12">
              ...
              >
                ...
                <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-white text-black flex items-center justify-center transition-transform duration-300 group-hover:rotate-45 shadow-sm">
