...
export default function CTAEnrollmentSection() {
  ...
  return (
    <section id="contact" className="w-full bg-gradient-to-b from-[#0d2746] via-[#081f38] to-[#051526] text-white pt-20 sm:pt-24 lg:pt-28 pb-14 sm:pb-16 lg:pb-20 relative overflow-hidden scroll-mt-12">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 relative z-10">
        <div className="max-w-3xl">
          ...
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#183454]/90 border border-[#2b4c73]/60 text-[10.5px] sm:text-[11px] font-semibold tracking-wider text-slate-200 uppercase backdrop-blur-sm">
            <span className="w-2 h-2 rounded-full bg-[#10b981] shadow-[0_0_8px_rgba(16,185,129,0.9)]" />
            <span>Early Pilot Enrollment</span>
          </div>

          {/* Main Headline */}
          <h2 className="text-3xl sm:text-4xl lg:text-[3.25rem] font-bold text-white tracking-tight leading-[1.16] mt-6 mb-4">
            Ready for hassle-free hospital visits?
          </h2>

          {/* Subtitle */}
          <p className="text-base sm:text-lg text-slate-300 font-normal leading-relaxed mb-8 sm:mb-10">
            Leave your email and we'll reach out when AarohCare launches near you.
          </p>

          {/* Premium Pill Contact Input Form */}
          <form onSubmit={handleSubmit} className="max-w-[620px] w-full">
        ...
        <div className="text-center pt-20 sm:pt-24 lg:pt-28">
