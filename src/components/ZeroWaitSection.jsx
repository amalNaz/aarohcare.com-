...
export default function ZeroWaitSection() {
  ...
  return (
    <section ref={containerRef} className="w-full bg-white text-slate-900 pt-16 sm:pt-24 lg:pt-32 pb-16 sm:pb-24 overflow-hidden">
      {/* Top Header & Description (Constrained Width) */}
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 mb-12 sm:mb-16">
        <p className="reveal-text text-xs sm:text-sm text-slate-500 max-w-xl leading-relaxed mb-8 sm:mb-12 font-normal">
